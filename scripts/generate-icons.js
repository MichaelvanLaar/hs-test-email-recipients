...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
  ...
  <circle cx="7.5" cy="17" r="2" fill="white"/>
  <path d="M3.5 23.5 C3.5 20.5 11.5 20.5 11.5 23.5" fill="white"/>
  <circle cx="16.5" cy="17" r="2" fill="white"/>
  <path d="M12.5 23.5 C12.5 20.5 20.5 20.5 20.5 23.5" fill="white"/>
</svg>`;
